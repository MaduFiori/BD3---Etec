...
insert into pacientes values (default, 'Maria', 'f', 'false');
insert into profissionais values (default, 'Guilherme');
insert into especialidades values (default, 'urologista');
insert into consultas values (default, 1,1,1);

insert into pacientes values (default, 'David', 'm', 'false');
insert into profissionais values (default, 'Maria');
insert into especialidades values (default, 'ginecologista');
insert into consultas values (default, 2,2,2);*/

insert into pacientes values (default, 'Clara', 'f', 'false');
insert into profissionais values (default, 'Raissa');
insert into especialidades values (default, 'ginecologista');
insert into consultas values (default, 3,3,3);
